CREATE PROCEDURE [dbo].[pe_NL_Detail_Report]
...
SET @SQL = 'SELECT tblTranNominal.*, TransTypeDescription, E.ClientCode, E.ClientName
FROM tblTranNominal LEFT OUTER JOIN tblTranTypes ON tblTranNominal.TransTypeIndex = tblTranTypes.TransTypeIndex LEFT OUTER JOIN tblEngagement E ON tblTranNominal.ContIndex = E.ContIndex
